...
function LoginContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.data?.test) params.set("test", "1");
        ...
        <div>
          ...
          <div className="flex min-w-0 gap-3">
            ...
            <input
              ...
              className="min-w-0 flex-1 rounded-xl border border-border-subtle bg-background px-4 py-3.5 text-sm font-medium text-foreground placeholder:text-secondary-text/70 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-surface"
              autoFocus
              autoComplete="tel"
              inputMode="numeric"
            />
